...
- (id)initWithFrame:(CGRect)frame 
{
    if ((self = [super initWithFrame:frame])) 
	{
        ...
        UIImageView *viewMark = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"viewMark"]];
        //float a= frame.size.height - pControllHeight - 45 -30;
        [viewMark setFrame:CGRectMake(280, 288, 30, 30)];
        [self addSubview:viewMark];
    }
    return self;
}
