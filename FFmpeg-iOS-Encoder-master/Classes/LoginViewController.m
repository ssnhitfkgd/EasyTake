...
{
    __block LoginViewController* basicHintView = [[[LoginViewController alloc] init] autorelease];
    ...
    basicHintView.customDismissedBlock = ^{
        ...
        [LoginViewController setHasDismissedHint:basicHintView.hintID];
    };
...
+(LoginViewController*) showLoginView
{
    ...
    basicHintView.hintView.textColor = [UIColor whiteColor];
    basicHintView.hintView.backgroundImage = [UIImage imageNamed:@"login.png"];
    basicHintView.hintView.spanWidthWeight = 0.95f;
    basicHintView.hintView.presentationAnimation = kHintViewPresentationSlide;
    basicHintView.icon = [UIImage imageNamed:@"90-lifebuoy"];
...
{
    if( ![LoginViewController hintsEnabled] )
    {
        return NO;
    }
